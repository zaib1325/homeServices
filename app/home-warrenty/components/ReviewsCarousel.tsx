...
import { ReviewCarousel } from '../page'
import {
    Carousel,
    CarouselContent,
    CarouselItem,
...
export default function ReviewsCarousel({ reviewCarousel }: ReviewsCarouselProps) {
    return (
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div>
                    <h2 className="text-3xl sm:text-4xl font-bold text-blue-900 mb-4">
                        {reviewCarousel.bottomRow.heading}
                    </h2>
                    <p className="text-base sm:text-lg text-gray-700 mb-12">
                        {reviewCarousel.bottomRow.subheading}
                    </p>
                    ...
                    >
                        <CarouselContent className="-ml-4">
                            {reviewCarousel.bottomRow.testimonials.map((testimonial, index) => (
